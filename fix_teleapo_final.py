# UTF-16 LEで読んでUTF-8で書き直す
with open(r'C:\Users\fyone\Desktop\teleapo_raw.tsx', 'r', encoding='utf-16') as f:
    c = f.read()

print('encoding OK, lines:', c.count('\n'))
print('sample:', repr(c[100:150]))
...
if marker in c:
    ...
    import re
    m = re.search(r'\{/\* Tab', c)
    if m: print('found:', repr(c[m.start():m.start()+40]))

...
{"recommended":["パターン名"],"reason":"刺さる理由2〜3文","issues":["AIが見つけた具体的課題1","課題2","課題3"],"tips":"架電注意ポイント","steps":{"step1":"【受付突破トーク本文】架電者=株式会社デバイスエージェンシーの米山。短く自信を持って目的をぼかす（補助金活用の件など）。禁止：情報収集していたところ/困っているのでは/締め切り煽り/ご案内があって/ご連絡いたしました。最後は必ず「ご支配人様か、ご担当者様はいらっしゃいますでしょうか？」","step2":"【担当者第一声＋ヒアリングのトーク本文】米山固定。①まずissuesに挙げた課題のうち最も刺さりそうな1つに触れて共感の一声を入れる②そのまま自然にヒアリング質問につなげる。例「実は貴ホテルの深夜チェックインについてお客様の声を拝見しまして…実際のところ夜間の対応はいかがでしょうか？」のように施設固有の課題を質問に組み込んだ自然な会話トークを生成する","step3":"","step4":"【アポ取りトーク本文】課題ありの場合。解決策＋補助金活用＋代行の強みでアポ獲得","step4b":"【情報置きトーク本文】課題なし・今は不要の場合。資料送付・次回架電につなぐ"},"opening":"step1と同内容"}`

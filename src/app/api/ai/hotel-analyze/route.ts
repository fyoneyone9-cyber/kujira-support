...
必ずJSON形式のみで出力（前後に説明不要）:
{
  ...
  "steps": {
    "step1": "【STEP1 受付突破】推奨パターンを全て組み合わせた1本の受付突破トーク。架電者は必ず「株式会社デバイスエージェンシーの米山」固定。プレースホルダー禁止。①IT補助金または人手不足補助金が使える旨②補助金申請から導入まで弊社が全て代行する旨を自然に盛り込む。推奨パターンが複数ある場合は両方の訴求を1つのトークにまとめること",

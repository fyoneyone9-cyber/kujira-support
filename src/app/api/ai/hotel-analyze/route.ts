...
{"recommended":["パターン名"],"reason":"刺さる理由2〜3文","issues":["課題1","課題2","課題3"],"tips":"架電注意ポイント","steps":{"step1":"【受付突破】架電者=株式会社デバイスエージェンシーの米山。短く・自信を持って・目的をぼかす（補助金活用の件など）。禁止：情報収集していたところ/困っているのでは/締め切り煽り/ご案内があって/ご連絡いたしました。最後は必ず「ご支配人様か、ご担当者様はいらっしゃいますでしょうか？」","step2":"【担当者第一声】米山固定。口コミ内容を反映した共感トーク","step3":"【ヒアリング】課題を引き出す質問","step4":"【アポ取り】解決策を組み合わせたアポ獲得","step4b":"【情報置き】資料送付・次回架電トーク"},"opening":"step1と同内容"}`

...
必ずJSON形式のみで出力（前後に説明不要）:
{
  ...
  "steps": {
    "step1": "【STEP1 受付突破】このホテル専用トーク。架電者は必ず「株式会社デバイスエージェンシーの米山」で固定。[あなたの会社名][あなたの名前]等のプレースホルダー禁止。必ず①IT補助金または人手不足補助金が使える旨②補助金申請から導入まで弊社が全て代行する旨を含める",
    "step2": "【STEP2 担当者への第一声】架電者は「米山」固定。このホテルの課題・業態に合わせた共感トーク（口コミの特徴や地域性を反映）",

...
必ずJSON形式のみで出力（前後に説明不要）:
{
  ...
  "steps": {
    "step1": "【STEP1 受付突破のみ】推奨パターン全てを組み合わせた1本の受付突破トーク。架電者は必ず「株式会社デバイスエージェンシーの米山」固定。プレースホルダー禁止。①IT補助金または人手不足補助金を活用した自動チェックイン機の導入②補助金申請から導入まで弊社が全て代行している旨を自然に盛り込む。スタンス：架電者は業界のプロとして「ご案内に参りました」というスタンスで話すこと。「情報収集していたところ」「知りました」「調べたところ」など素人っぽい表現は絶対禁止。絶対禁止ワード：「情報が見当たらない」「困っているのではないか」「お困りごとがあるのではないか」「まもなく申請締め切り」「締め切りが迫っております」「お急ぎください」。「ご連絡いたしました」禁止→「ご連絡させていただきました」を使う。トークの最後は必ず「ご支配人様か、ご担当者様はいらっしゃいますでしょうか？」で締める",

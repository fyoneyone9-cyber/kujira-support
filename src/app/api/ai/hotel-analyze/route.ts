...
{"recommended":["パターン名"],"reason":"刺さる理由2〜3文","issues":["AIが見つけた具体的課題1","課題2","課題3"],"tips":"架電注意ポイント","steps":{"step1":"【受付突破トーク本文】架電者=株式会社デバイスエージェンシーの米山。短く自信を持って目的をぼかす（補助金活用の件など）。禁止：情報収集していたところ/困っているのでは/締め切り煽り/ご案内があって/ご連絡いたしました。最後は必ず「ご支配人様か、ご担当者様はいらっしゃいますでしょうか？」","step2":"【担当者第一声＋ヒアリングのトーク本文】米山固定。構成：①一言挨拶＋IT補助金または人手不足補助金を活用したご案内である旨を短く（1〜2文）②issuesの中で最も刺さりそな課題に触れて共感の一声③そのままヒアリング質問につなげる。補助金は長々説明せず「実はIT補助金を活用したご案内でして」程度にサラッと入れる。施設固有の課題を質問に自然に組み込むこと","step3":"","step4":"【アポ取りトーク本文】課題ありの場合。解決策＋補助金活用＋代行の強みでアポ獲得","step4b":"【情報置きトーク本文】課題なし・今は不要の場合。資料送付・次回架電につなぐ"},"opening":"step1と同内容"}`

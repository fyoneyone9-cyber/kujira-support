...
必ずJSON形式のみで出力（前後に説明不要）:
{
  ...
  "steps": {
    "step1": "【STEP1 受付突破のみ】受付に内容を判断させず支配人・担当者につなげることだけを目的とした短いトーク。架電者は必ず「株式会社デバイスエージェンシーの米山」固定。プレースホルダー禁止。受付突破の鉄則：①「補助金活用の件」「業務効率化支援の件」など受付が自分では判断できないワードを使って目的をぼかす②長々と説明しない・短く自信を持って話す③「〜についてご案内があって」など営業とバレる表現は使わない。スタンス：プロとして自信を持って話す。「情報収集していたところ」「知りました」「調べたところ」など素人表現は絶対禁止。絶対禁止ワード：「情報が見当たらない」「困っているのではないか」「お困りごとがあるのではないか」「まもなく申請締め切り」「締め切りが迫っております」「お急ぎください」「〜についてご案内があって」。「ご連絡いたしました」禁止→「ご連絡させていただきました」を使う。トークの最後は必ず「ご支配人様か、ご担当者様はいらっしゃいますでしょうか？」で締める",
